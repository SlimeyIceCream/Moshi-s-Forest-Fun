...
package net.mcreator.moshispvpaddons.world.biome;
...
import net.mcreator.moshispvpaddons.block.LeigrassfixBlock;
import net.mcreator.moshispvpaddons.block.LeiWoodLogBlock;
import net.mcreator.moshispvpaddons.block.LeiWoodLeavesBlock;
...
public class LeiForestyrBiome extends MoshisPvpAddonsModElements.ModElement {
	public static Biome biome;
	public LeiForestyrBiome(MoshisPvpAddonsModElements instance) {
		super(instance, 58);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(LeigrassfixBlock.block.getDefaultState(),
								Blocks.STONE.getDefaultState(), Blocks.STONE.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(LeiWoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(LeiWoodLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("moshis_pvp_addons:lei_forestyr"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("lei_forestyr_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, LeiWoodLeavesBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("lei_forestyr_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
