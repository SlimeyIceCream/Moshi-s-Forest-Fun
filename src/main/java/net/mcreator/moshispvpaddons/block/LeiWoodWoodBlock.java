...
public class LeiWoodWoodBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_wood")
	public static final Block block = null;
	public LeiWoodWoodBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 1);
	}
