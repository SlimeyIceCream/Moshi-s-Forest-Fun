...
public class LeiWoodPlanksBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_planks")
	public static final Block block = null;
	public LeiWoodPlanksBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lei_wood_planks");
		}
