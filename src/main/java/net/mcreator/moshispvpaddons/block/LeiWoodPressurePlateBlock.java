...
public class LeiWoodPressurePlateBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_pressure_plate")
	public static final Block block = null;
	public LeiWoodPressurePlateBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("lei_wood_pressure_plate");
		}
