...
public class LeigrassfixBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:leigrassfix")
	public static final Block block = null;
	public LeigrassfixBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 62);
	}
