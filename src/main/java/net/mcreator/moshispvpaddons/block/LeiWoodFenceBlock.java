...
public class LeiWoodFenceBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_fence")
	public static final Block block = null;
	public LeiWoodFenceBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("lei_wood_fence");
		}
