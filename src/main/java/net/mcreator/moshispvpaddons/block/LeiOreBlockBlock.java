...
public class LeiOreBlockBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_ore_block")
	public static final Block block = null;
	public LeiOreBlockBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 38);
	}
