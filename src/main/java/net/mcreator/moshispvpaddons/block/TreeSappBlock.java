...
public class TreeSappBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:tree_sapp")
	public static final Block block = null;
	public TreeSappBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 60);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tree_sapp"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("moshis_pvp_addons:tree_sapp"), configuredFeature);
		}
	}
	@SubscribeEvent
