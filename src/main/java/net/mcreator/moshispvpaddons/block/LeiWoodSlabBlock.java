...
public class LeiWoodSlabBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_slab")
	public static final Block block = null;
	public LeiWoodSlabBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 6);
	}
