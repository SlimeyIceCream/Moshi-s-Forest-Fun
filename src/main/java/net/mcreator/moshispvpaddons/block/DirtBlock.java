...
public class DirtBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:dirt")
	public static final Block block = null;
	public DirtBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 63);
	}
