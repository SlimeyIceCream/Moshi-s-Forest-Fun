...
public class LeiWoodLogBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_log")
	public static final Block block = null;
	public LeiWoodLogBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 2);
	}
