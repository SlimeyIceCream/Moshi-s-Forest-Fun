...
public class LeiWoodLeavesBlock extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_wood_leaves")
	public static final Block block = null;
	public LeiWoodLeavesBlock(MoshisPvpAddonsModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("lei_wood_leaves");
		}
