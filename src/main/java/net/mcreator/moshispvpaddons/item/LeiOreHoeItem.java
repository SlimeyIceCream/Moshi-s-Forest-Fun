...
public class LeiOreHoeItem extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_ore_hoe")
	public static final Item block = null;
	public LeiOreHoeItem(MoshisPvpAddonsModElements instance) {
		super(instance, 46);
	}
