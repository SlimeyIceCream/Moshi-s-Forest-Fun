...
public class LeiPickPickaxeItem extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_pick_pickaxe")
	public static final Item block = null;
	public LeiPickPickaxeItem(MoshisPvpAddonsModElements instance) {
		super(instance, 26);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("lei_pick_pickaxe"));
	}
}
