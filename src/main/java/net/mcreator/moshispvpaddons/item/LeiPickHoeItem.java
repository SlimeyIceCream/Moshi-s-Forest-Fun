...
public class LeiPickHoeItem extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_pick_hoe")
	public static final Item block = null;
	public LeiPickHoeItem(MoshisPvpAddonsModElements instance) {
		super(instance, 30);
	}
