...
public class LeiPickSwordItem extends MoshisPvpAddonsModElements.ModElement {
	@ObjectHolder("moshis_pvp_addons:lei_pick_sword")
	public static final Item block = null;
	public LeiPickSwordItem(MoshisPvpAddonsModElements instance) {
		super(instance, 28);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("lei_pick_sword"));
	}
}
